...
function download_zip(filename, base64) {
  ...
  function save_zip(){
	  ...
	  zip.generateAsync({type:"blob"}).then(function (data) { saveAs(data, zip_name()); document.getElementById("project_txt").innerHTML = '';	document.getElementById("save_button").disabled = false;});
  }
  ...
  function zip_name(){
	  ...
	  return 'webveta_' + ( date.getMonth()+1 ) + '-' + date.getDate() + '-' + date.getHours() + ':' + date.getMinutes() + ':' + date.getSeconds() + '.zip';
  }
		  ...
		  .then(function(zip) {
			  ...
			  zip.file("settings.json").async("string").then(function (data) {
					  try{
						  ...
						  // image_url = content.image_url; image_changed = true;
						  ...
						  if(TWI_MODE == 0) {
							  ...
							  document.getElementsByClassName("twi_mode")[1].innerHTML =	"All TWIs";
						  }
						  else if(TWI_MODE == 1) {
							  document.getElementsByClassName("twi_mode")[0].innerHTML =	"Selected TWI Group";	
							  document.getElementsByClassName("twi_mode")[1].innerHTML =	"Selected TWI Group";
						  }
						  else if(TWI_MODE == 2) {
							  document.getElementsByClassName("twi_mode")[0].innerHTML =	"Selected TWI";	
							  document.getElementsByClassName("twi_mode")[1].innerHTML =	"Selected TWI";
						  }
						  ...
						  if(LENSE_MODE == 0){
							  document.getElementsByClassName("lense_mode")[0].innerHTML =	"Selected Lense Group";	
						  }
						  else if(LENSE_MODE == 1){
							  document.getElementsByClassName("lense_mode")[0].innerHTML =	"Selected Lense";	
						  }
